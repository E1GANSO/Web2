...
<form class="formoid-metro-cyan" style="background-color:#FFFFFF;font-size:14px;font-family:'Open Sans','Helvetica Neue','Helvetica',Arial,Verdana,sans-serif;color:#666666;max-width:720px;min-width:150px" method="post"><div class="title"><h2>Registro</h2></div>
	...
	<div class="element-radio<?php frmd_add_class("radio"); ?>"><label class="title">Ocupación<span class="required">*</span></label>		<div class="column column2"><label><input type="radio" name="radio" value="Docente" required="required"/><span>Docente</span></label></div><span class="clearfix"></span>
